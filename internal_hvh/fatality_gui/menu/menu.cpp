...
void c_menu::init()
{
	...
	c_tab* tab_first = main_window->add_tab( _w( "Rage" ) );
	{
		...
		c_subtab* subtab_three = tab_first->add_subtab( _w( "Anti-aim" ) );
		{
			...
			subtab_three->add_keybind(_w("Slowwalk"), _w("aa_slowwalk_key"));
			subtab_three->add_slider(_w("Slowwalk amount"), _w("aa_slowwalk"), 0.f, 100.f, _w("%.2f %%"));



			subtab_three->add_checkbox(_w("Aimware desync"), _w("aa_aimwaredesync"));

			subtab_three->add_combobox(_w("Aimware desync type"), _w("aa_aimwaredesync_type"), &aimware_type);
			subtab_three->add_combobox(_w("Aimware desync rbot"), _w("aa_aimwaredesync_rbot"), &aimware_rbot);
