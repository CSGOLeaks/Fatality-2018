								   ...
								   bool bUpdatePositions, float soundtime, int speakerentity, int something )
{
	...
	orig_emit_sound( pThis, filter, iEntIndex, iChannel, pSoundEntry, nSoundEntryHash, pSample, flVolume, flAttenuation, nSeed, iFlags, iPitch, pOrigin, pDirection, pUtlVecOrigins, bUpdatePositions, soundtime, speakerentity, something);
}