...
{
	static auto fnGetItemSchema = reinterpret_cast< uintptr_t( __stdcall* )( ) >( sig( "client_panorama.dll", "A1 ? ? ? ? 85 C0 75 53" ) );
	return fnGetItemSchema();
}

void util::DestroyEconItem( CEconItem* item )
{
	static auto fn_CEconItem = reinterpret_cast< int( __thiscall* )( void*, bool ) >( sig( "client_panorama.dll", "55 8B EC 56 8B F1 8B 4E 18 C7 06 ? ? ? ? C7 46 ? ? ? ? ? 85 C9 74 05" ) );
	fn_CEconItem( item, true );
}

CEconItem* util::CreateEconItem()
{
	static auto fnCreateSharedObjectSubclass_EconItem_ = reinterpret_cast< CEconItem*( __stdcall* )( ) >( *reinterpret_cast< uintptr_t* >( sig( "client_panorama.dll", "C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4 C7 45 ? ? ? ? ? 50 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? E8 ? ? ? ? 83 F8 FF 75 09 8D 45 E4 50 E8 ? ? ? ? 8D 45 E4" ) + 3 ) );
