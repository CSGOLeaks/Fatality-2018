...
namespace fonts
{
	...
	std::shared_ptr<c_font> esp_small = std::make_shared<c_font>( "Visitor TT2 BRK", 9, 400 ); //Smallest Pixel-7", 11, 400
	std::shared_ptr<c_font> lby = std::make_shared<c_font>( "Porter", 18, 600 ); // "Verdana", 27, 800 
