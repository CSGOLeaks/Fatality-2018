...
{
	static auto fnRemoveItem = reinterpret_cast< int( __thiscall* )( void*, int64_t ) >( sig( "client_panorama.dll", "55 8B EC 83 E4 F8 56 57 FF 75 0C 8B F1" ) );
...
{
	static auto fnGCSDK_CGCClient_FindSOCache = reinterpret_cast< uintptr_t( __thiscall* )( uintptr_t, uint64_t, uint64_t, bool ) >( sig( "client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 1C 0F 10 45 08" ) );
	static auto fnGCSDK_CSharedObjectCache_CreateBaseTypeCache = reinterpret_cast< CSharedObjectTypeCache*( __thiscall* )( uintptr_t, int ) >( sig( "client_panorama.dll", "55 8B EC 51 53 56 8B D9 8D 45 08" ) );
...
{
	static auto fnGetInventoryItemByItemID = reinterpret_cast< C_EconItemView*( __thiscall* )( void*, int64_t ) >( sig( "client_panorama.dll", "55 8B EC 8B 55 08 83 EC 10 8B C2" ) );
...
{
	static auto fnAddEconItem = reinterpret_cast< C_EconItemView*( __thiscall* )( void*, CEconItem*, int, int, char ) >( sig( "client_panorama.dll", "55 8B EC 83 E4 F8 A1 ? ? ? ? 83 EC 14 53 56 57 8B F9 8B 08" ) );
...
{
	static auto fnFindOrCreateReferenceEconItem = reinterpret_cast< C_EconItemView*( __thiscall* )( void*, int64_t ) >( sig( "client_panorama.dll", "55 8B EC 51 8B 55 0C 53 56" ) );
...
{
	static auto fnFilloutItemFromEconItem = reinterpret_cast< char( __thiscall* )( void*, void*, void* ) >( sig( "client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 0C 53 56 8B F1 8B 86" ) );
...
{
	static auto fnEquipItemInLoadout = reinterpret_cast< bool( __thiscall* )( void*, int, int, uint64_t, bool ) >( sig( "client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 2C 83 3D" ) );
