...
{
	static auto fnUpdateEquippedState = reinterpret_cast< int( __thiscall* )( CEconItem*, unsigned int ) >( sig( "client_panorama.dll", "55 8B EC 8B 45 08 8B D0 C1 EA 10" ) );
...
{
	static auto Address = sig( "client_panorama.dll", "E8 ? ? ? ? 8B 46 78 C1 E8 0A A8 01 74 13 8B 46 34" );
...
{
	static auto Address = sig( "client_panorama.dll", "E8 ? ? ? ? 33 DB 39 5E 3C 7E 5E" );
