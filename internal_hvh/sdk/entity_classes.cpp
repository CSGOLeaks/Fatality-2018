...
{
	Vector out;
	util::get_vfunc<void( __thiscall* )( void*, Vector& )>( this, 284 )( this, out );
	return out;
}
...
void C_CSPlayer::set_pose_params_scaled( std::array<float, 24>& params )
{
	...
	static auto GetPoseParameterRange = reinterpret_cast< GetPoseParameterRange_t >( sig( "client_panorama.dll", "55 8B EC 56 8B F1 83 BE ? ? ? ? ? 75 14 8B 46 04 8D 4E 04 FF 50 20 85 C0 74 07 8B CE E8 ? ? ? ? 8B 8E ? ? ? ? 85 C9 74 49 83 39 00 74 44 8B 55 08" ) );
...
{
	static auto Studio_SetPoseParameter = reinterpret_cast< void* >( sig( "client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 08 F3 0F 11 54 24 ? 85 D2" ) );
