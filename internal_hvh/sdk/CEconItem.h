...
public:
	...
	void SetAttributeValue( int index, TYPE val )
	{
		...
		static auto fnSetDynamicAttributeValue = reinterpret_cast< int( __thiscall* )( CEconItem*, DWORD, void* ) >( sig( "client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 3C 53 8B 5D 08 56 57 6A 00" ) );
